...
public enum Environments {
    INSURANCE_SERVER_NOTIFAANO_IR; //TODO: Write general description for this element

    private static TreeMap<String, Environments> valueMap = new TreeMap<String, Environments>();
    private String value;

    static {
        INSURANCE_SERVER_NOTIFAANO_IR.value = "Insurance - server.notifaano.ir";

        valueMap.put("Insurance - server.notifaano.ir", INSURANCE_SERVER_NOTIFAANO_IR);
    }
